...
struct Mouse
{
	...
	*******************************************************************************/
	void handleMotion(inout SDL_Event event)
	{
		...
		// emit signal
		arc.internals.input.signals.signals.mouseMove(Point(x2D, y2D));
	}
	...
	*******************************************************************************/
	void handleButtonDown(inout SDL_MouseButtonEvent event)
	{
		...
		// raise signal
		arc.internals.input.signals.signals.mouseButtonDown(event.button, Point(x2D, y2D));
	}
	...
	*******************************************************************************/
	void handleButtonUp(inout SDL_MouseButtonEvent event)
	{
		...
		// raise signal
		arc.internals.input.signals.signals.mouseButtonUp(event.button, Point(x2D, y2D));
	}
