...
class Entity 
{
	...
	*******************************************************************************/
	bool xyCol(Point p)
	{
		...
		if (p.x > pos.x && p.x < pos.x + max_size && p.y > pos.y && p.y < pos.y + max_size) 
		{
			return true;
		}
	...
	*******************************************************************************/
	...
	bool onScreen() 
	{
		...
		if( pos.x >= -max_size && pos.x <= arc.window.coordinates.getWidth + max_size && pos.y >= -max_size && pos.y <= arc.window.coordinates.getHeight + max_size) 
			return true;
	...
	*/
	...
	final Color getColor() { return attr.fill; }
