...
class Sprite : Entity
{
  public:	
	...
	void drawBounds()
	{
		...
		if (col == COLLISION_TYPE.BOX)
			drawRectangle(Point(getLeftX, getTopY), Size(getWidth, getHeight), attr);
		else if (col == COLLISION_TYPE.RADIUS)
		{
			drawCircle(Point(getLeftX+getHalfWidth, getTopY+getHalfHeight), radius, attr);
		}
	}
